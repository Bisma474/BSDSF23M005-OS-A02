/*
 * src/ls-v1.4.0.c — Feature 4
 * -----------------------------------------------
 * Features:
 *  - Reads directory contents into memory
 *  - Sorts entries alphabetically (locale-aware)
 *  - Displays columns "down then across" by default
 *  - Supports `-x` option for horizontal display
 *  - Supports `-l` option for long listing
 */
